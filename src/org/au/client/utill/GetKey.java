...
public class GetKey implements NativeKeyListener {
    private static SimpleLogger logger = new SimpleLogger("GetKey", SimpleLogger.Level.DEBUG);
    @Override
    public void nativeKeyPressed(NativeKeyEvent e) {
        ...
        if(Main.type==0) {
            logger.debug("KeyPressed:" + NativeKeyEvent.getKeyText(e.getKeyCode()));
        }
    }
    @Override
    public void nativeKeyReleased(NativeKeyEvent e) {
        ...
        if(Main.type==0) {
            logger.debug("KeyReleased:" + NativeKeyEvent.getKeyText(e.getKeyCode()));
        }
    }
    @Override
    public void nativeKeyTyped(NativeKeyEvent e) {
        ...
        if(Main.type==0) {
            logger.debug("KeyTyped:" + NativeKeyEvent.getKeyText(e.getKeyCode()));
        }
    }
}